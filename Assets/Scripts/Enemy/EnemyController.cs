...
public class EnemyController : MonoBehaviour
{
    ...
    private IEnumerator PauseCoroutine(float pauseDuration, float pauseStrength)
    {
        ...
        isPaused = true;
        float healthBeforePause = enemyStats.health;
        Color colorBeforePause = GetComponent<SpriteRenderer>().color;
        yield return new WaitForSeconds(pauseDuration);
        GetComponent<SpriteRenderer>().color = colorBeforePause;
        enemyStats.health = healthBeforePause;
        ResumeEnemy();
    }
